...
export function __wbg_httpreader_free(a: number, b: number): void;
export function httpreader_new(a: number, b: number): number;
export function httpreader_select_all(a: number): number;
export function httpreader_select_bbox(a: number, b: number, c: number, d: number, e: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h139506c88bdf33a7(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h97183d96270ce9ff(a: number, b: number, c: number, d: number): void;

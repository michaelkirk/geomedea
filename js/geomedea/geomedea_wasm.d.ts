...
export interface InitOutput {
  ...
  readonly __wbg_httpreader_free: (a: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h419d317bd0eb6109: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly wasm_bindgen__convert__closures__invoke2_mut__he8074bf1608777bb: (a: number, b: number, c: number, d: number) => void;
}

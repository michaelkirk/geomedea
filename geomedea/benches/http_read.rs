...
fn benchmark(c: &mut Criterion) {
    ...
    let compressed_url =
        format!("http://localhost:{test_server_port}/USCounties-compressed.geomedea");
    let uncompressed_url =
        format!("http://localhost:{test_server_port}/USCounties-uncompressed.geomedea");
